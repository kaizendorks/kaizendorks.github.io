  ...
  <section id="header-wrapper">
    <header id="header">
      <div class="header-wrapper">
        <div class="logo">
          <a href="/">
            <img :src="$withBase('/logo_navbar.png')" alt="logo">
          </a>
        </div>
        <div class="title">
...
<script>
// This component has been copied from the @vuepress/theme-blog component
// The only changes made were adding the logo to the navbar
import SearchBox from '@SearchBox'
import Feed from '@vuepress/theme-blog/components/Feed'
